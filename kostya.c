...
void exp_check()
{
	...
	ft_printf("my: %015e\n", -2.0f);
	printf("FLOAT_CHECKER\n");
	int	ret1 = printf("%e", 35.1234);
	printf("\n");
	int	ret2 = ft_printf("%e", 35.1234);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%018.7e", -6.1234);
	printf("\n");
	ret2 = ft_printf("%018.7e", -6.1234);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%+18.7e", -351.234);
	printf("\n");
	ret2 = ft_printf("%+18.7e", 351.234);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%9.15E", 890234.f);
	printf("\n");
	ret2 = ft_printf("%9.15E", 890234.f);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%-12.56e", -23.9);
	printf("\n");
	ret2 = ft_printf("%-12.56e", -23.9);
	printf("\nor: %d\nmy: %d\n\n", ret1 ,ret2);

	ret1 = printf("%07.E", -23.74);
	printf("\n");
	ret2 = ft_printf("%07.E", -23.74);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%016.23e", 323.4);
	printf("\n");
	ret2 = ft_printf("%016.23e", 323.4);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%023E", -3694.2);
	printf("\n");
	ret2 = ft_printf("%023E", -3694.2);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%E", 35.1234);
	printf("\n");
	ret2 = ft_printf("%E", 35.1234);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%56.28e", -1.000000);
	printf("\n");
	ret2 = ft_printf("%56.28e", -1.000000);
	printf("\nor: %d\nmy: %d\n\n",ret1, ret2);

	ret1 = printf("%024e", 345.123490650);
	printf("\n");
	ret2 = ft_printf("%024e", 345.123490650);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);

	ret1 = printf("%56.28E",-9223372036854775808.000000);
	printf("\n");
	ret2 = ft_printf("%56.28E", -9223372036854775808.000000);
	printf("\nor: %d\nmy: %d\n\n", ret1, ret2);
	ft_printf("my: %e|\n", 1.00);
	printf("og: %e|\n", 1.00);
	ft_printf("my: %E|\n", 32.23);
